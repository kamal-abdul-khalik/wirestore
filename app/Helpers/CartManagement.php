...
class CartManagement
{
    ...
    public static function addItemToCart($product_id)
    {
        ...
        if ($existing_item !== null) {
            ...
            $product = Product::whereId($product_id)->first(['id', 'name', 'price', 'images']);
            if ($product) {
                $cart_items[] = [
    ...
    //add items to cart wiht quantity
    ...
    public static function incrementQuatityToCartItem($product_id)
    {
        $cart_items = self::getCartItemsFromCookie();
        foreach ($cart_items as $key => $item) {
            if ($item['product_id'] == $product_id) {
    ...
    public static function decrementQuatityToCartItem($product_id)
    {
        $cart_items = self::getCartItemsFromCookie();
        foreach ($cart_items as $key => $item) {
            if ($item['product_id'] == $product_id) {
