<div>
    <div class="w-full px-4 py-16 mx-auto bg-gradient-to-r from-blue-200 to-cyan-200 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600">WireStore</span></h1>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                @foreach ($brands as $brand)
                    <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $brand->id }}">
                        <a href="/products?selectedBrands[0]={{ $brand->id }}" wire:navigate>
            ...
            <div class="grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-6">
                @foreach ($categories as $category)
                    <a class="flex flex-col transition bg-white border shadow-sm group rounded-xl hover:shadow-md dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        href="/products?selectedCategories[0]={{ $category->id }}" wire:key='{{ $category->id }}'
                        wire:navigate>
                    ...
                    <div
                        ...
                        <div class="flex items-center px-6 mb-2 md:mb-0 ">
                            <div class="flex mr-2 rounded-full">
                                <img src="/storage/categories/01HXRJVAQF1QQ8C7ZHV64GM10W.png" alt=""
