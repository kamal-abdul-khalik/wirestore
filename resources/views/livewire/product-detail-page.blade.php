                ...
                <div class="w-full px-4 md:w-1/2">
                    <div class="lg:pl-20">
                        <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4">
                            ...
                            <p class="max-w-md prose text-gray-700 dark:text-gray-400 prose-slate">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <button wire:click='addToCart({{ $product->id }})'
                                class="flex items-center justify-center w-full p-4 space-x-2 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    fill="currentColor" class="w-4 h-4 font-semibold bi bi-cart3" viewBox="0 0 16 16">
                                    <path
